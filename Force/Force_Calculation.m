function [F,Frz,Ftz,Mrz,ForceIntegral,FourierBr,FourierBt,FourierFr,FourierFt,FourierRad,FourierTan,FourierTq,Force]...
    =Force_Calculation(Br,Bt,Freq,ForceNum,mu0,L,Ris,Qs,alpha_b0,Space,TimeStep,AngleStep,TimeDomain,f0,Force_method)
%% Force Calculation
%======================= flux density ==============================
% imported
% ====================== force density =============================
...
[~,time_loc]=ismember(Freq,FourierRad.P.Frequency);
...
[~,time_loc]=ismember(Freq,FourierTan.P.Frequency);
...
[~,time_loc]=ismember(Freq,FourierTq.P.Frequency);
