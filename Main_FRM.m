...
%             case 'sin'
                        ...
                        [Barm,Bpm,Bg,Barm_slot]=FluxCal(time,Barm_fun,Bpm_fun,Ipeak,Islot,Basic_speed,speed,Nt);
%                 Br=Bg.rad';
%                 Bt=Bg.tan';
...
% FRF_Order=[1 2 3 4];
% damp=1/(2*pi)*(2.76*10^-5*FRF_freq+0.062);
