        ...
        case 'load'
            switch current
                case 'harm'
                    ...
                    Bt=Bg.tan';
                case 'sin'
                    [Iph,Islot]=Current(n3ph,m,p,Nt,Ipeak,f0,T,time(1:end),gamma,'sin',I_harm{i},SlotMatrix,ap);
                    [Barm,Bpm,Bg,Barm_slot]=FluxCal(time(1:end),Barm_fun,Bpm_fun,Ipeak,Islot,Basic_speed,speed(i),Nt);
                    Br=Bg.rad';
                    Bt=Bg.tan';
            end
            Test=TestLoad;
        case 'noload'
            [Iph,Islot]=Current(n3ph,m,p,Nt,Ipeak,f0,T,time(1:end),gamma,'harm',I_harm{i},SlotMatrix,ap);
            [Barm,Bpm,Bg,Barm_slot]=FluxCal(time(1:end),Barm_fun,Bpm_fun,Ipeak,Islot,Basic_speed,speed(i),Nt);
            Br=Bom.rad';
            Bt=Bpm.tan';
            Test=TestNoload;
