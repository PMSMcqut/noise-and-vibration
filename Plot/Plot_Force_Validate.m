...
% ----- 图形属性设置--------------------------------------------------
subplot(3,2,1)
h=plot(Time(1:TimeStep)',[ForceIntegral.rad(1,1:TimeStep)',ForceJmag.rad(1:TimeStep,1)]);
...
% ----- 图形属性设置--------------------------------------------------
subplot(3,2,3)
h=plot(Time(1:TimeStep)',[ForceIntegral.tan(1,1:TimeStep)',ForceJmag.tan(1:TimeStep,1)]);
NameArrayFig={'LineWidth','Marker','LineStyle','color'};
ValueArrayFig={1.5,'none','-.','b';
    1.5,'none','-','r'};% 行数代表了图形中的有几个绘图的对象，列数代表了每个对象有几个属性
set(h,NameArrayFig,ValueArrayFig);
...
% ----- 图形属性设置--------------------------------------------------
subplot(3,2,5)
h=plot(Time(1:TimeStep)',[ForceIntegral.tq(1,1:TimeStep)',ForceJmag.tq(1:TimeStep,1)]);
NameArrayFig={'LineWidth','Marker','LineStyle','color'};
ValueArrayFig={1.5,'none','-.','b';
    1.5,'none','-','r'};% 行数代表了图形中的有几个绘图的对象，列数代表了每个对象有几个属性
set(h,NameArrayFig,ValueArrayFig)
